...
<pre>
    ...
    <div class="container padding40">
    	<div class="row">
    		<h2>Folding</h2>
            <div class="eightcol"><p class="para">Vim can fold blocks of code. Select the lines to be folded in vim (for example, using the linewise visual mode) and then press <kbd>z</kbd><kbd>f</kbd> keys to make it folded. You can open the fold using <kbd>z</kbd><kbd>o</kbd> and to close it back press <kbd>z</kbd><kbd>c</kbd></p></div>
